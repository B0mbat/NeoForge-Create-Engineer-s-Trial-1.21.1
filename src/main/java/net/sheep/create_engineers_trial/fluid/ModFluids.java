...
public class ModFluids {
    ...
    public static final BaseFlowingFluid.Properties MOLTEN_PLASTIC_PROPERTIES = new BaseFlowingFluid.Properties(
            ModFluidTypes.MOLTEN_PLASTIC_FLUID_TYPE, SOURCE_MOLTEN_PLASTIC, FLOWING_MOLTEN_PLASTIC)
            .slopeFindDistance(2).levelDecreasePerBlock(1)
            .block(ModFluids.MOLTEN_PLASTIC_BLOCK).bucket(ModFluids.MOLTEN_PLASTIC_BUCKET);
